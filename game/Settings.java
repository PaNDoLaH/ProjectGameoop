...
public class Settings {
    ...
    private String PLAYER1_DEFAULT = "jigglypuff";
    private String PLAYER2_DEFAULT = "psyduck";
    private int PLAYER1_HEALTH = 500;
    private int PLAYER2_HEALTH = 500;
    ...
    private int HEALTH_BAR_PLAYER1 = 350;
    private int HEALTH_BAR_PLAYER2 = 350;

    private int SPECIAL_ATTACK_DAMAGE = 20;

    private final String UI_BACKGROUND_COLOR = "#FF5733";
