...
public class Player extends Sprite {
    ...
    public void keyPressed(KeyEvent e) throws IOException {
        ...
        if (key == KeyEvent.VK_SPACE && getPLAYER_SIDE() == 1) {
            specialAttack(
                    "https://raw.githubusercontent.com/antoniocruz23/PokeFight/main/resources/images/blue-fireball-p1.gif");
            return;
        }
        ...
        if (key == KeyEvent.VK_ENTER && getPLAYER_SIDE() == 0) {
            specialAttack(
                    "https://raw.githubusercontent.com/antoniocruz23/PokeFight/main/resources/images/blue-fireball-p2.gif");
            return;
        }
